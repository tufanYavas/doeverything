...
export type StorageConfigType<D = string> = {
  ...
  serialization?: {
     ...
     * May be async (e.g. when wrapping fields with Web Crypto).
     */
    serialize: (value: D) => unknown | Promise<unknown>;
    /**
     * convert string value from storage to non-native values.
     * May be async (e.g. when unwrapping encrypted fields).
     */
    deserialize: (text: unknown) => D | Promise<D>;
  };
};
