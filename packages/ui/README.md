...
```ts
import baseConfig from '@doeverything/tailwindcss-config';
...
```css
@import '@doeverything/ui/global.css';
```
...
```tsx
import { CustomComponent, ErrorDisplay, LoadingSpinner } from '@doeverything/ui';
    ...
    export function withUI(tailwindConfig: Config): Config {
      return deepmerge(
        ...
        deepmerge(tailwindConfig, {
          content: ['./node_modules/@doeverything/ui/lib/**/*.{tsx,ts,js,jsx}'],
        }),
      );
    }
...
```css
@import '@doeverything/ui/lib/global.css';
