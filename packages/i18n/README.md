...
```typescript
import { t } from '@doeverything/i18n';
...
If you want to enforce displaying specific language, you need to set `DOE_DEV_LOCALE` in `.env` file (work only for development).
