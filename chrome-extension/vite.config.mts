...
import { watchPublicPlugin, watchRebuildPlugin } from '@doeverything/hmr';
import { watchOption } from '@doeverything/vite-config';
import env, { IS_DEV, IS_PROD } from '@doeverything/env';
